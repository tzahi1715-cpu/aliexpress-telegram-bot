...
keywords = [
    "earbuds", "smart watch", "power bank", "led strip", "phone case",
    "back pain relief", "sleep aid", "phone holder car", "cable organizer",
    "mosquito killer", "posture corrector", "kitchen gadgets", "shoe insoles",
]
ki = 0
sent = set()
