...
DICTIONARY = {
    ...
    "תיק יד": "women handbag",
    "תיק גב": "backpack women",
    "תיק צד": "crossbody bag",
    "ארנק": "wallet women",
    "נעליים": "shoes women",
    "נעלי עקב": "high heels",
    "כפכפים": "sandals women",
    "נעלי ספורט": "sneakers women",
    "שמלה": "dress women",
    "חולצה": "blouse women",
    "מעיל": "coat women",
    "צעיף": "scarf women",
    "כפפות": "gloves women",
    "משקפי שמש": "sunglasses women",
    "שעון": "watch women",
    "שעון חכם": "smart watch",
    "אוזניות": "earbuds wireless",
    "טלפון": "phone case",
    "מטען": "power bank",
    "תכשיטים": "jewelry women",
    "אביזרים": "accessories women",
    "סיכה": "brooch",
    "קליפס": "hair clips",
    "גומי שיער": "hair ties",
}
            ...
            if text and not text.startswith("/"):
                ...
                if text:
                    ...
                    if products:
                        ...
                        send_telegram("😔 לא נמצאו מוצרים מעל ₪20, נסה מילת חיפוש אחרת.", chat_id=chat_id)
        except Exception as e:
            print(f"Handle error: {e}")
    return offset

print("Starting...")
send_telegram("🤖 הבוט התחיל!\n\nשלח לי מילת חיפוש ואמצא לך מוצרים 🛍\nלדוגמא: שרשרת זהב, תיק עור, כובע צמר")
time.sleep(2)
